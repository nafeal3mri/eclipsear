...
class _SolarPageState extends State<SolarPage> {
  ...
  @override
  void didUpdateWidget(SolarPage old) {
  ...
  EclipseTheme get _theme {
    if (widget.nextEclipse == null) {
      return EclipseTheme.forSolar('notVisible', 0.0);
    }
...
class _HeroCardState extends State<_HeroCard> {
  ...
  void _updateRemaining() {
    ...
    final maxDt = '${widget.nextEclipse['date']} ${widget.nextEclipse['maxEclipse']}';
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.nextEclipse == null) {
      return Padding(
        ...
        child: Center(
          child: Text(
            widget.eclipseCategory == 'solar'
                ? loc.noUpcomingSolarEclipse
...
class _EclipseListTile extends StatelessWidget {
  final dynamic eclipseData;
  final String eclipseCategory;
  final bool isNext;
  final EclipseTheme theme;

  const _EclipseListTile({
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => Navigator.push(
        ...
        MaterialPageRoute(
          builder: (_) => EclipseDetailsPage(
            title: DateFormatter().getdatetimgformatted(false, eclipseData['date']),
